...
\todo[inline]{präziser bzgl. kann man als simples}

\subsection{Abgrenzung}

\todo[inline]{@marc konsistente gedankenstriche}
...
\todo[inline]{@marc alignierung und textunterschrift}
...
Als Erweiterung ist es möglich, verschiedene \e{Meshes} eines glTF zu kombinieren und als ein einziges \e{Mesh} zu behandeln. Dies erlaubt es noch mehr Vereinfachungen vornehmen zu können. Diese Anpassung kann man als simples HLOD-System bezeichnen. Eine Schwierigkeit ist hier jedoch die sinnvolle Wahl der Textur, da vereschiedene \e{Meshes} häufig über verschiedene Texturen verfügen und diese ebenfalls kombiniert werden müssten.
