...
Nebst dem \gls{CLI} soll folglich auch ein JavaScript-Paket bereitgestellt werden, welches das Laden von \e{glTF} Dateien übernimmt und basierend auf der erkannten Performanz das beste Level of Detail einspielt.
