...
Die Basisstruktur von glTF basiert auf \fgls{JSON}{JavaScript Object Notation, Austauschformat, welches häufig in der Web-Entwicklung eingesetzt wird}. Darin ist die komplette Szenerie des Modells beschrieben und in Abbildung \ref{fig:gltfDatastructure} aufgezeigt \cite{gltfTutorialStructure}.
\begin{figure}[H]
  \centering
