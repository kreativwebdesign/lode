...
\end{figure}
\todo[inline]{stylify pipeline bilder -> "pipeliniger", weniger bunt, ...}
...
\todo[inline]{erweitern mit detaillierteren Informationen}
...
\todo[inline]{nachteile -> beleuchtung}
...
\todo[inline]{clustering erläutern (bei DLOD?)}
...
\todo[inline]{scene graph glossary (entry refactoren)}
...
\todo[inline]{point cloud refactoren: glossary in text, point cloud als punkte ohne fläche, delaunay?}
...
\todo[inline]{detailliertere Auslegeordnung?}
