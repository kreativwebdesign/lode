...
\end{bmatrix}
$$
Um komplexere Formen wie \e{Quads} (Vierecke) zu bilden, werden jeweils mehrere \e{Triangle} kombiniert. Abbildung \ref{fig:modelSimpleTriangulation} zeigt die Vereinfachung eines \e{Quads} in zwei \e{Triangle}.
\begin{figure}[H]
  \centering
