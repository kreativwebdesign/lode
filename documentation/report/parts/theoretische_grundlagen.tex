...
\begin{figure}[H]
  ...
  \begin{subfigure}{.45\textwidth}
    ...
    \caption{Originalmodell mit für \e{Edge Collapse} gewählten \e{Edge} in Rot}
  \end{subfigure}\hfill%
  \begin{subfigure}{.45\textwidth}
    \centering
...
\begin{figure}[H]
  ...
  \begin{subfigure}{.45\textwidth}
    \centering
    \includegraphics[width=.7\linewidth]{grundlagen/transformationen/edge-collapse-original.png}
    \caption{Originalmodell mit für \e{Halfedge Collapse} gewählten \e{Edge} in Rot}
  \end{subfigure}\hfill%
  \begin{subfigure}{.45\textwidth}
    \centering
...
\begin{figure}[H]
  ...
  \begin{subfigure}{.45\textwidth}
    ...
    \caption{Modell nach \e{Vertex Removal} mit veränderten \e{Vertices} in Rot}
...
Eine weitere Möglichkeit ist das \e{Vertex Clustering}, hierbei wird ein Modell in verschiedene Gitterzellen aufgeteilt. Die \e{Vertices} innerhalb einer Gitterzelle werden dann in einen einzigen \e{Vertex} zusammengelegt. Die visuelle Annäherung dieser Algorithmen stellt bei drastischen Vereinfachungen von polygonalen Modellen jedoch häufig ein Problem dar. Sogenannte \e{Point Cloud} können mit solchen Algorithmen schnell vereinfacht werden.
