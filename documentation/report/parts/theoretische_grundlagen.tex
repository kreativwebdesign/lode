...
\todo[inline]{Texture mapping / UV Mapping erklären (fussnote obsolet)}
...
Um die Oberfläche von Modellen zu definieren, wird häufig \fgls{Texture Mapping}{Verfahren, um mittels 2D-Bildern 3D-Objekte zu gestalten} durchgeführt. Hierfür sind zusätzliche Informationen für ein Modell notwendig. In der Praxis finden weitere Methoden Anwendung, auf diese wird jedoch hier nicht weiter eingegangen.
...
\todo[inline]{Draw Call erläutern}
...
Damit wird die Anzahl \fGlspl{Draw Call}{Ein Aufruf auf die GPU, um ein Objekt zu zeichnen. Ein \e{Draw Call} wird pro Material pro \e{Mesh} benötigt. Es ist besser, weniger, dafür umfangreiche \e{Draw Calls} abzusetzen, als viele Kleinere. Dies kommt daher, dass die GPU extrem schnell ist und sich die Unterbrechung durch einzelne Aufrufe viel negativer auswirkt} reduziert und somit die Performanz erhöht.
