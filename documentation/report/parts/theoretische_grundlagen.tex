...
Diese Unabhängigkeit der Hardware bedeutet jedoch auch, dass Optimierung der Performance in Web Anwendungen unabdinglich ist um allen Benutzern ein optimales Erlebnis zu ermöglichen.
