...
\paragraph{Three.js}
Ist die wohl weitverbreiteste Bibliothek für 3D-Rendering im Web \cite{threeNpmPackage}. Die Community hinter Three.js ist aktiv und das offene Produkt wird somit konstant weiterentwickelt. Insbesondere die Erweiterungen für \e{React}, eine populäre Bibliothek für die Entwicklung von Frontend Applikationen, zeigen den Innovationsdrang \cite{threeFiberGithub}.
