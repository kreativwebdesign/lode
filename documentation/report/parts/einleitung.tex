...
Eine Möglichkeit zur Optimierung ist das Generieren und Verwenden von vereinfachten Modellen. In diversen \e{\gls{Rendering Engines}} gibt es deshalb Möglichkeiten für das Verwenden von Level Of Details (\gls{LOD}) Artefakten. Dabei werden abhängig von Parametern vereinfachte Varianten desselben Modelles verwendet. So kann z.B. ein Objekt in grosser Distanz vereinfacht dargestellt werden, ohne merkbare Auswirkungen auf die Qualität zu haben.
Für \e{\gls{Game Engines}} wie Unreal oder Unity gibt es Möglichkeiten, um den Einsatz von \gls{LOD} Artefakten zu vereinfachen. Im Web Bereich gibt es zur Zeit keine weit verbreitete Möglichkeit.

\section{Zielsetzung}
Ziel der Arbeit ist es, ein Tool zu entwickeln, das den Umgang mit \gls{LOD} Artefakten im Web vereinfacht.
