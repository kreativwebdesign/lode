...
\section{Zielsetzung}
Ziel der Arbeit ist es, ein Tool zu entwickeln, das den Umgang mit LOD Artefakten im Web vereinfacht. Hierfür muss vorab der Beleg erbracht werden, dass das Laufzeitverhalten der Applikation mit LOD Artfakten verbessert werden kann. Des Weiteren muss ein Algorithmus entwickelt werden, welcher es erlaubt Modelle zu vereinfachen, ohne die grobe geometrische Form zu verlieren. Im Anschluss muss dieses Tool zur Verfügung gestellt werden, sodass es in der Praxis eingesetzt werden kann. Diese Zielsetzung definiert somit direkt die verschiedenen Schritte der Arbeit.
