...
\paragraph{Verwendung der Artefakten in die Applikation}
...
Direkt damit verbunden ist die Anzahl \e{total Renders}, welche genauso um ca 30\% gesteigert werden kontte. Auf der Umkehrseite wurde die \e{total model load duration} etwas erhöht, da mehr Modelle geladen werden müssen. Diese wuchs aber nur um rund 10\%.
