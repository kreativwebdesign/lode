...
\todo[inline]{mehr details über Implementation: boundary normalization, optimal point, matrices...}
...
\end{figure}
\todo[inline]{Durch visuelle diagramme ersetzen.}
...
\todo[inline]{Kennzahlen-Bezeichnung auf deutsche version aus Tabelle (und Diagramme) referenzieren}