...
In diesem Abschnitt wird das Benchmarksetup erläutert. Die verschiedenen technischen Entscheide werden detailliert aufgezeigt.
...
\begin{enumerate}
  \item Öffne Applikation in einer \emph{Chromium} Instanz.
...
Die \e{Render Loop} ist eine Schleife, welche kontinuierlich die Grafikpipeline durchläuft.
