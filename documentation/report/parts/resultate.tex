...
3D-Modelle werden erstellt und als \e{glTF}-Dateien innerhalb des Projekts gespeichert. Eine zu den Modellen gehörige Konfigurationsdatei (Abbildung \ref{fig:lodeConfigFile}) kann mittels \gls{CLI}, welches auf \e{NPM} verfügbar ist, angelegt werden (Abbildung \ref{fig:lodecliconfig}).
