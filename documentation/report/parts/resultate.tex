...
\todo[inline]{Step by step anleitung? (von blender zu justierung in Three.js)}
...
\end{figure}
\todo[inline]{screenshots mit npx @kweb und ohne cwd}
\todo[inline]{erwähnung npm package}
...
\todo[inline]{mehr details über Implementation: boundary normalization, optimal point, matrices, detailablauf...}
...
\todo[inline]{screenshots im studio modus @marc}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\columnwidth]{resultate/fpsChartMarcbook.jpg}
  \caption{FPS Vergleich}
  \label{fig:fpsComparisonChartMarcbook}
\end{figure}
\todo[inline]{Schreibe etwas über diagramm und füge weitere hinzu}
...
Direkt damit verbunden ist die Anzahl \e{Render Loop} Iterationen, welche genauso um ca 30\% gesteigert werden konnte. Auf der Umkehrseite wurde die Dauer für das Laden der Modelle etwas erhöht, da mehr Modelle geladen werden müssen. Diese wuchs aber nur um rund 10\%.
