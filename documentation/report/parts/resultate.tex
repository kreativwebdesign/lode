...
Die Artefakte können innerhalb der Applikation mithilfe einer Bibliothek geladen werden. Dabei werden die Spezifikationen in der Konfigurationsdatei geladen und entsprechend in die Szenerie geladen.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\columnwidth]{resultate/lod-comparison.png}
