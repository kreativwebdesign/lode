...
\begin{table}[H]
  ...
  \hline
  Kriterium & DLOD & CLOD & HLOD \\
  Auswirkung auf Downloadgrösse & mittel & klein & klein \\ 
  Auswirkung auf Laufzeitverhalten & klein & mittel & klein \\
  Integration in bestehende Arbeitsabläufe & einfach & einfach & umständlich \\
  \hline
  \end{tabular}
  \caption{Vergleichsmatrix für LOD Systeme}
...
Eine weitere Möglichkeit ist das \e{Vertex Clustering}, hierbei wird ein Modell in verschiedene Gitterzellen aufgeteilt. Die Punkte innerhalb einer Gitterzelle werden dann in einen einzigen Punkten zusammengelegt.
