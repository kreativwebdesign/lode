...
Wann welches Level angezeigt wird, kann ebenfalls eingestellt werden. \e{Unreal} bietet eine automatische Option, so wie auch eine manuelle, wobei für jedes Level der Triggerpunkt gewählt werden kann.
...
\todo[inline]{erklärung weshalb visual pop nicht entscheidendes kriterium ist}
