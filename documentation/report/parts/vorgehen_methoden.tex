...
Angestrebt werden grundsätzlich immer 60 \fgls{FPS}{Frames per Second. Bilder pro Sekunde. Gängige Art, die Performanz der \gls{Rendering Engine} zu messen}. Wenn eine bestimmte Szenerie diese 60 \e{\gls{FPS}} nicht erreicht ist ein Performanzproblem vorhanden. Bei diesem Ansatz wird für eine Szenerie möglichst geringfügig angepasst und die Auswirkungen auf die Performanz verglichen.
