...
Eine unabhängige Arbeit definierte 2017 einen vergleichbaren Benchmark um die Performanz von Three.js und Babylon.js in einem spezifischen Anwendungsgebiet zu vergleichen. Der Benchmark misst die System Daten unabhängig von der Browser Instanz. \cite{performanceComparisonBabylonThreejs}
...
\paragraph{Profiling}
Die \e{Chrome DevTools} erlauben es, ein detailliertes Laufzeit Profil einer Applikation anzulegen.
...
Um während den Tests möglichst faire Bedingungen zu gewährleisten wird die Maschine zuvor wie bei anderen Benchmarks vorbereitet. Für diesen Benchmark wurden deshalb die Instruktionen von Tracer Bench zur Behebung von Rauschen.
...
Zudem wurde entschieden kein hierarchisches LOD System zu entwickeln um die Integration des Tools für die Entwickler einer Web Anwendung möglichst einfach zu gestalten.
