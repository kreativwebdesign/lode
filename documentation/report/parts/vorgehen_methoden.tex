...
(TODO: Evtl könnte man hier noch genauer darauf eingehen, wie die Systeme funktionieren und mit Bildern zeigen.)
...
\section{Nutzen LOD}
Um den Nutzen von LOD quantifizieren zu können, müssen verschiedene Aspekte berücksichtigt werden. (TODO: Bisschen ausführen)
...
Entscheidend ist, unabhängig von der Applikation, das Laufzeitverhalten. (TODO: Was genau ist "Das Laufzeitverhalten") Eine Applikation, welche eine schlechte \e{User Experience} liefert, ist inakzeptabel.
