...
\bigbreak
In dieser Arbeit werden verschiedene Ansätze zum Einsatz von \e{LOD}-Artefakten, sowie ihre Vor- und Nachteile, aufgezeigt.
...
\bigbreak
Das Resultat ist ein Toolset, welches es ermöglicht, mit geringem manuellen Aufwand \e{LOD}-Artefakte zu generieren und in 3D-Web-Applikationen einzusetzen.
...
Mittels eines Benchmarks wird bewiesen, dass der Einsatz von \e{LOD} die Laufzeitleistung von gewissen 3D-Web-Applikationen verbessern kann.
